...
class QueryEncoder:
    def __init__(self):
        self.model = FlagModel('BAAI/bge-base-en-v1.5', query_instruction_for_retrieval="Represent this sentence for searching relevant passages: ", use_fp16=False)
        
    def encode(self, query_text):
        return self.model.encode(query_text, batch_size=1) # experiment showed that this ran the fastest per document
